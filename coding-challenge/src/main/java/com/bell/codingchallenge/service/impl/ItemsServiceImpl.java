...
public class ItemsServiceImpl implements ItemsService {
	...
	public ResponseWrapperDTO getMediaList(Integer NoOfMedia) {
		...
		ResponseEntity<ItemsType> listOfMedias = BellMethodUtil.restTemplate
				.getForEntity(BellVariableUtil.BELL_API_FOR_LIST_OF_MEDIA + NoOfMedia, ItemsType.class);
	...
	public ResponseWrapperDTO getMediaDetailsById(Integer id) {
		ResponseEntity<ItemsDetails> responseEntity = BellMethodUtil.restTemplate
				.getForEntity(BellVariableUtil.BELL_API_FOR_MEDIA_DETAILS + id, ItemsDetails.class);
	...
	public ResponseWrapperDTO getMediaDetailsByIdAndType(Integer id, String imageType) {
		...
		ItemsDetails itemDetails = responseEntity.getBody();
